...
const SideBar = () => {
  ...
  const topMenu = [
    getItem(<a href="https://ant.design">주문관리</a>, '1', <FontAwesomeIcon icon={faFilePen} />),
  ...
  return (
      <div style={{ padding: '40px 20px 40px 20px', width: '260px', height: '100vh', borderRight: '1px solid #ccc', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', zIndex:'999' }}>
        <div>
