...
const SideBar = () => {
  ...
  return (
    <div style={{ padding: '40px 20px 40px 20px', width: '300px', height: '100vh', borderRight: '1px solid #ccc', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', zIndex: '999', position: 'fixed' }}>
      <div>
