...
const SideBar = () => {
  ...
  const bottomMenu = [
    getItem(<a href="/users">사용자 관리</a>, '9', <CalendarOutlined />),
    getItem(<a href="/">로그아웃</a>, '10', <CalendarOutlined />),
  ];

  return (
    <div style={{ backgroundColor: '#fff', borderRight: '1px soild #ccc', padding: '40px 20px 40px 20px', width: '300px', minHeight: '100vh', position: 'absolute', boxSizing: 'border-box', zIndex: '99', float: 'left' }}>
