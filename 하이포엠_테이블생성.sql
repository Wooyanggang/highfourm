...
create table IF NOT EXISTS product (
	product_id varchar(50) NOT NULL COMMENT '제품 코드', #유니크 빠짐
...
create table IF NOT EXISTS production_plan (
    ...
    product_id varchar(50) NOT NULL COMMENT '제품 코드',
    order_id varchar(50) NOT NULL COMMENT '주문 코드',  #유니크 제거
...
create table IF NOT EXISTS process (
	process_id varchar(50) NOT NULL COMMENT '공정 코드', #유니크 빠짐
	product_id varchar(50) NOT NULL COMMENT '제품 코드', #유니크 제거
...
create table IF NOT EXISTS required_material (
	product_id varchar(50) NOT NULL COMMENT '제품 코드', #유니크 제거
    material_id varchar(50) NOT NULL COMMENT '원자재 코드', #유니크 제거
...
create table IF NOT EXISTS material_history (
	...
	material_id varchar(50) NOT NULL COMMENT '자재 코드', #유니크 제거
