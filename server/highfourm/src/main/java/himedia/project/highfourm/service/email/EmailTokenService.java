...
//	
//	// 이메일 인증 토큰 생성
//	public String createEmailToken(Long userNo, String receiverEmail) {
//		
//		Assert.notNull(userNo, "사용자번호는 필수입니다.");
//		Assert.hasText(receiverEmail, "수신자 이메일은 필수입니다.");
//		
//		EmailToken emailToken = EmailToken.createEmailToken(userNo);
...
//				+"'&userNo=\'"+emailToken.getUserNo()+"'>인증 링크</a>'"
//				+"</div>";
//		
